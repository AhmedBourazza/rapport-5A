...
de la suite~\cite{ms_graph}. À côté subsistent deux approches historiques,
propres à SharePoint~: le modèle objet client (CSOM) et l'API REST
SharePoint~\cite{ms_sp_access}. Ces trois voies coexistent dans les
applications du service, les plus anciennes s'appuyant encore sur CSOM.
...
réécriture complète, qui repart de zéro mais concentre les risques, et la
refonte incrémentale, qui fait évoluer l'existant par étapes tout en le gardant
fonctionnel et livrable. C'est cette seconde voie qui a été retenue pour
\csbag.
