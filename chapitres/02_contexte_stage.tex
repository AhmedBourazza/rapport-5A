...
validation des formations et passeports obligatoires, portant notamment sur la
sécurité des systèmes d'information et sur les règles d'usage de l'intelligence
artificielle, seul GitHub~Copilot étant autorisé. Le premier lot a été lancé à
l'issue de cette semaine.
...
Wrike constitue ainsi le support quotidien de l'organisation~: chaque lot de
\csbag y correspond à un projet dédié, découpé en tâches suivies sur un tableau
agile dont les colonnes matérialisent l'état d'avancement. C'est également dans
cet outil que sont consignées les demandes de support et les incidents remontés
par les utilisateurs, ce qui permet d'arbitrer entre travaux planifiés et
sollicitations non prévues. L'organisation des espaces et le suivi d'un lot sont
illustrés en~\ref{ann:wrike}.
