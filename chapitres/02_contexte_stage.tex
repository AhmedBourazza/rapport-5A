...
Une mission transverse, plus courte mais représentative du travail
d'exploitation en production, a porté sur une application existante. Elium
...
échouait en production. Cette mission est détaillée au
...
illustrés en annexe~\ref{ann:wrike}.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}p{3.8cm} X}
    ...
    Rédaction du rapport & \LaTeX{} via la plateforme Overleaf \\
    \bottomrule
  \end{tabularx}
\end{table}
