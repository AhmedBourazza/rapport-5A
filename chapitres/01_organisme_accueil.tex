...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    racine/.style={rectangle, rounded corners, draw=vinciblue, very thick,
      fill=vinciblue, text=white, minimum width=2.6cm, minimum height=0.85cm,
      align=center},
    branche/.style={rectangle, rounded corners, draw=vinciblue, thick,
      fill=vinciblue!10, minimum width=2.4cm, minimum height=0.75cm, align=center},
    feuille/.style={rectangle, rounded corners, draw=gray, thick,
      fill=grisclair, minimum width=2.2cm, minimum height=0.65cm, align=center},
    lien/.style={-, draw=gray, thick}
  ]
    \node[racine] (vinci) at (0,0) {VINCI};

    \node[branche] (conc) at (-5.2,-1.6) {VINCI\\Concessions};
    \node[branche] (ve)   at (-2.6,-1.6) {VINCI\\\textbf{Energies}};
    \node[branche] (vc)   at ( 0.0,-1.6) {VINCI\\Construction};
    \node[branche] (cobra) at ( 2.6,-1.6) {Cobra~IS};
    \node[branche] (immo) at ( 5.2,-1.6) {VINCI\\Immobilier};
    ...
    \node[feuille] (auto) at (-6.2,-3.2) {VINCI\\Autoroutes};
    \node[feuille] (airp) at (-4.2,-3.2) {VINCI\\Airports};
    \draw[lien] (conc) -- (auto);
    \draw[lien] (conc) -- (airp);

    \node[feuille] (eurovia) at (0.0,-3.2) {Eurovia};
