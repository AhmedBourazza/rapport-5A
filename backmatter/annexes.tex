...
\begin{figure}[H]
  \centering
  \screenshot[0.48\textwidth]{csbag_v1_detail_module.png}
  \caption{Détail d'un module (version~1)~: ressources en texte libre.}
...
\begin{figure}[H]
  \centering
  \screenshot[0.48\textwidth]{csbag_v1_modif_module.png}
  \caption{Modification d'un module (version~1)~: saisie libre des ressources.}
